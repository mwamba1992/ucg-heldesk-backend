...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Categories list retrieved' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Root categories retrieved' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(enums_1.UserRole.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Deactivate category (Admin only)' }),
