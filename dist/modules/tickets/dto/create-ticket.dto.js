...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Cannot access email', description: 'Ticket title' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'I am unable to access my email since this morning...' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Building A, Floor 2' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
